    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h1 className="text-4xl font-bold mb-4 neon-text">
          {t('order.success.title', 'Payment Successful!')}
        </h1>
        
        <p className="text-xl text-gray-300 mb-8">
          {t('order.success.message', 'Thank you for your purchase. Your order has been confirmed.')}
        </p>
          ...
          <div className="cyber-card rounded-lg p-6 mb-8 text-left">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold capitalize text-green-500">{order.paymentStatus}</span>
              </div>
